...
server.go          — HTTP server: SSE handler, /api/report, /api/health, /api/export/ndjson, /api/export/html, dashboard serving, configurable Prefix, CORS middleware (secure-by-default: empty=disabled), New() convenience, ServeHTTP

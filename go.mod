...
require (
	...
	github.com/larsartmann/go-output/markup v0.21.0
	github.com/larsartmann/go-output/plantuml v0.21.0
	github.com/larsartmann/go-output/serialization v0.21.0
...
require (
	...
	github.com/larsartmann/go-output/escape v0.21.0 // indirect
